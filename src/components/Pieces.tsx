...
type ChessPieceSize = "xs" | "s" | "m" | "l" | "xl";

const sizeClasses: Record<ChessPieceSize, string> = {
  xs: "w-4 h-4",
  s: "w-6 h-6",
  m: "w-8 h-8",
  l: "w-12 h-12",
...
// Enhanced base SVG wrapper with strong outline
const PieceSVG: React.FC<{ children: React.ReactNode } & ChessPieceProps> = ({
  children,
  color = "white",
  size = "m",
  className = "",
...
// Individual piece components with strong outlines
export const King: React.FC<ChessPieceProps> = (props) => (
  <PieceSVG {...props}>
...
export const Queen: React.FC<ChessPieceProps> = (props) => (
  <PieceSVG {...props}>
    <path d="M 9,26 C 17.5,24.5 30,24.5 36,26 L 38,14 L 31,25 L 31,11 L 25.5,24.5 L 22.5,9.5 L 19.5,24.5 L 14,10.5 L 14,25 L 7,14 L 9,26" />
...
export const Rook: React.FC<ChessPieceProps> = (props) => (
  <PieceSVG {...props}>
...
export const Bishop: React.FC<ChessPieceProps> = (props) => (
  <PieceSVG {...props}>
...
export const Knight: React.FC<ChessPieceProps> = (props) => (
  <PieceSVG {...props}>
    ...
    <path d="M 15 15.5 A 0.5 1.5 0 1 1 14,15.5 A 0.5 1.5 0 1 1 15 15.5" />
  </PieceSVG>
);

export const Pawn: React.FC<ChessPieceProps> = (props) => (
  <PieceSVG {...props}>
